...
namespace TutorManagementiOS
{
    ...
    public partial class UserUpdatePageTeacher : ContentPage
    {
        FirebaseRepo db = new FirebaseRepo();
        public UserUpdatePageTeacher()
        {
            var vm = new ViewModelUpdateTeacher();
        ...
        async Task setOldValAsync()
        {
            ...
            var lister = await db.GetTeacherByID(AuthorizationPage.typeUserId);
